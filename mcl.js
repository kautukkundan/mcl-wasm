  ...
  const setup = (exports, curveType) => {
    ...
    const _wrapInput = (func, argNum) => {
      return function () {
        ...
        if (
          ["[object String]", "[object Uint8Array]", "[object Array]"].indexOf(
            typeStr
          ) < 0
        ) {
          throw new Error(
            `err bad type:"${typeStr}". Use String or Uint8Array.`
          );
        }
    ...
    mod.mclBnFr_setLittleEndianMod = _wrapInput(
      mod._mclBnFr_setLittleEndianMod,
      1
    );
    ...
    mod.mclBnFp_setLittleEndianMod = _wrapInput(
      mod._mclBnFp_setLittleEndianMod,
      1
    );
    ...
    exports.precomputedMillerLoop = (P, Qcoeff) => {
      if (!(P instanceof exports.G1 && Qcoeff instanceof exports.PrecomputedG2))
    ...
    exports.precomputedMillerLoop2 = (P1, Q1coeff, P2, Q2coeff) => {
      if (
        !(
          P1 instanceof exports.G1 &&
          Q1coeff instanceof exports.PrecomputedG2 &&
          P2 instanceof exports.G1 &&
          Q2coeff instanceof exports.PrecomputedG2
        )
      )
      ...
      const ePos = e._alloc();
      mod._mclBn_precomputedMillerLoop2(
        ePos,
        P1Pos,
        Q1coeff.p,
        P2Pos,
    ...
    exports.precomputedMillerLoop2mixed = (P1, Q1, P2, Q2coeff) => {
      ...
      const P2Pos = P2._allocAndCopy();
      const ePos = e._alloc();
      mod._mclBn_precomputedMillerLoop2mixed(
        ePos,
        P1Pos,
        Q1Pos,
        P2Pos,
